...
<body>
    ...
    <table class="table-primary table-hover col-10 ml-5 text-center">
        ...
        <?php foreach ($publicaciones as $publicacion) { ?>
            <tr class="table-warning">
                ...
                <td class="p-2"> <a href="MuroVerDe.php?id=<?= $emisor['id'] ?>"><?= $emisor["nombre"] ?></a></td>
    ...
    <form class="col-md-12 text-center" action="PublicacionNuevaCrear.php">
        ...
        <div class="text-center">
            ...
            <a class="btn btn-outline-success col-sm-3" href='MuroVerDe.php?id=<?= $_SESSION["id"] ?>'>Ir a mi muro.</a>
        </div>
    </form>
</body>
